...
up :: MyState -> MyState
up (S (x,y) l s m) = S (x-1,y) l "up"	(S (x,y) l s m)

down :: MyState -> MyState
down (S (x,y) l s m) = S (x+1,y) l "down"	(S (x,y) l s m)

left :: MyState -> MyState
left (S (x,y) l s m) = S (x,y-1) l "left"	(S (x,y) l s m)

right :: MyState -> MyState
right (S (x,y) l s m) = S (x,y+1) l "right"	(S (x,y) l s m)					 
...
move (S c l s m) = moveh (movev (S c l s m) (nearest c l (1000000,1000000))) (nearest c l (1000000,1000000))
...
solve c l = constructSolution (search (S c l "" Null)) 
